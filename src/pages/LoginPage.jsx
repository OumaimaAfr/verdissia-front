            ...
            <div style={{
                ...
                >
                    ...
                    <Form layout="vertical" onFinish={onFinish} autoComplete="off" requiredMark={false}>
                        <Form.Item 
                            name="username" 
                            label={<span style={{ color: '#374151', fontWeight: '600', fontSize: '15px' }}>Adresse email</span>} 
                            rules={[{ required: true, message: "L'adresse email est requise." }]}
                        >
                            <Input 
                                ...
                                placeholder="exemple@verdissia.com"
                            />
                        </Form.Item>
