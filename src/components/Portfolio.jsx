function Portfolio(){
    return (
        <section id="portfolio" className="portfolio-area portfolio-2">
            <div className="container">
                <div className="row justify-content-center">
                    <div className="col-lg-6">
                        <div className="section-title text-center pb-20">
                            <h3 className="title">Our Portfolio</h3>
                            <p className="text">Stop wasting time and money designing and managing a website that
                                doesn’t get results. Happiness guaranteed!</p>
                        </div>
                    </div>
                </div>
                <div className="row">
                    ...
                    <div className="col-lg-4 col-sm-6 branding-3 planning-3">
                        <div className="single-portfolio mt-30">
                            <div className="portfolio-image">
                                <img src="/template-assets/images/portfolio-3.png" alt=""/>
                                <div className="portfolio-overlay d-flex align-items-center justify-content-center">
                                    <div className="portfolio-content">
                                        <div className="portfolio-icon">
                                            <a className="image-popup" href="/template-assets/images/portfolio-3.png"><i
                                                className="lni-zoom-in"></i></a>
                                        </div>
                                        <div className="portfolio-icon">
                            ...
                            <div className="portfolio-text">
                                ...
                                <p className="text">Short description for the ones who look for something new.
                                    Awesome!</p>
                            </div>
                        </div>
                    </div>
